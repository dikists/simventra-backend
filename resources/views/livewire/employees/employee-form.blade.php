                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        @elseif($isEdit && ($existingPhoto ?? $employee?->photo))
                            <img src="{{ Storage::disk(config('filesystems.default_public_disk'))->url($existingPhoto ?? $employee->photo) }}" class="w-32 h-32 rounded-full mx-auto object-cover mb-3 border-4 border-blue-100">
                        @else
